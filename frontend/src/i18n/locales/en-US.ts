export default {
  ...
  knowledgeEditor: {
    ...
    indexing: {
      ...
      wikiDesc: 'Auto-generate interlinked wiki pages. Spreadsheet documents use field semantics and table structure by default, not per-row data.',
      graphTitle: 'Knowledge Graph',
      graphDesc: 'Extract entities and relationships. Spreadsheet documents use field semantics and table structure by default, not per-row graph nodes.',
